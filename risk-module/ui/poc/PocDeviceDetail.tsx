...
// Ported from gui/frontend/src/components/DeviceDetail.jsx.
...
export default function PocDeviceDetail({ node }: { node: GraphNode }) {
  ...
  const ports =
    node.kind === "device" && node.port_status ? Object.entries(node.port_status) : [];

  return (
    <div className="detail">
      <div className="detail__head">
        <div className={`detail__id ${offline ? "is-offline" : ""}`}>
          <span className="detail__icon" style={{ ["--risk" as string]: color }}>
